...
import { Zap, BookOpen, Layers, Brain, PenLine, ArrowRight, Check, Sparkles, Star } from 'lucide-react'
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="animate-fade-up delay-400 relative mx-auto max-w-lg">
            ...
            <div className="absolute -top-4 -left-8 sm:-left-16 float-badge rounded-2xl px-3.5 py-2.5 animate-float flex items-center gap-2 z-10 hidden sm:flex">
              ...
              <div>
                <p className="text-xs font-bold text-gray-800">Socratic mode</p>
                <p className="text-[10px] text-gray-400">hints, not answers</p>
              </div>
            </div>
            <div className="absolute -bottom-4 -right-8 sm:-right-14 float-badge rounded-2xl px-3.5 py-2.5 animate-float flex items-center gap-2 z-10 hidden sm:flex" style={{ animationDelay: '-3s' }}>
              ...
              <div>
                <p className="text-xs font-bold text-gray-800">Any subject</p>
                <p className="text-[10px] text-gray-400">math to history</p>
              </div>
            </div>
          ...
          <ScrollReveal direction="scale">
            <div className="glass-blue rounded-3xl p-8 text-center">
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-left">
                <div className="glass rounded-2xl p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-glass-hover">
                ...
                <div className="glass rounded-2xl p-5 ring-2 ring-electric/30 relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-electric">
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
            {pricing.map((plan, i) => (
              <ScrollReveal key={plan.name} direction={i === 0 ? 'left' : 'right'} delay={i * 100}>
                <div
                  className={`rounded-3xl p-8 relative overflow-hidden transition-all duration-300 hover:-translate-y-2 h-full ${
                    plan.highlight
